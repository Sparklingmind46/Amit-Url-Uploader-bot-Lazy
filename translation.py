...
URL | filename | username | password"""
    DOWNLOAD_START = "Download started in **Rocket mode...🚀😎**"
...
Contact ADMIN if any error occurs @Shareef_insaaan"""
...
𝐀𝐦𝐢𝐭 has not allowed me to upload files from the urls which is send by an unAuthorised member.

Please contact my Developer to be an authorised user ! 
"""
    LAZY_DEVELOPER_TEXT = """▍║▍▏║ Hello Dear 𝐌𝐚𝐬𝐭𝐞𝐫 ║▍▏║▍
⭑┗┫⦀⦙ {} ⦙⦀┣┛⭑
